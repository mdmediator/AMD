...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/mdmediator/AMD"
  ...
  s.source       = { :git => "https://github.com/mdmediator/AMD.git", :tag => s.version.to_s }
  ...
  s.source_files  = "AMD/AMD/**/*.{h,m,swift}"
